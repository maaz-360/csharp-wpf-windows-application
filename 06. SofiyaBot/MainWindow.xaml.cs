...
public partial class MainWindow : Window
{
    ...
    {
        InitializeComponent();
        var videoPath = System.IO.Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Assets", "SofiaBotEquilizer.mp4");
    ...
    {
#if DEBUG
        defaultCommandsPath = System.IO.Path.GetFullPath(
            System.IO.Path.Combine(baseDebugDirectory, @"..\..\..\DefaultCommands.txt"));
#else
            defaultCommandsPath = System.IO.Path.Combine(baseDebugDirectory, @"\DefaultCommands.txt");
#endif
